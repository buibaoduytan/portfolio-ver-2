        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-2 mb-6">
                    <div className="w-full h-full rounded-full bg-white dark:bg-gray-800 flex items-center justify-center">
                      <img src="public/images/avt.jpg" alt="Duy Tân" className="w-full h-full object-cover rounded-full" />
                    </div>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Bùi Bảo Duy Tân</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                ...
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="text-gray-600 dark:text-gray-300">Công nghệ thành thạo</div>
                </div>
              </div>
